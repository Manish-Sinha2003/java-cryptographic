...
//        	String passcode = "YourSecretKey";  
        	...
        	SecretKey passcode = generateSecretKey();
        	// Replace with your actual secret key
//        	SecretKey sharedKey = new SecretKeySpec(passcode.getBytes(), "HmacSHA256");
            ...
            byte[] senderMac = computeMac(transactionMessage, passcode);
            ...
            boolean isVerified = verifyMac(transactionMessage, senderMac, passcode);
            ...
            byte[] tamperedMac = computeMac(tamperedMessage, passcode);
            boolean isTamperedVerified = verifyMac(tamperedMessage, senderMac, passcode); // Using the original MAC
