...
//        	SecretKey secretKey = new SecretKeySpec(passcode.getBytes(), "HmacSHA256");
            ...
            byte[] generatedMac = generateMac(message, passcode);
            ...
            boolean isValid = verifyMac(message, generatedMac, passcode);
            ...
            boolean isTampered = verifyMac(tamperedMessage, generatedMac, passcode);
